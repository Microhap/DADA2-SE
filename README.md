...
1. A **configuration file** for STRait Razor format conversion: <br>`MH24_241224.config`
2. **Two FASTQ files for 2800M reference DNA**: <br>`2800M#1_S1_L001_R1_001.fastq` and `2800M#2_S2_L001_R1_001.fastq`
